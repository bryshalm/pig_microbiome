...
```{r}
path <- "/home/brymoore/wsg_gtdb_tax/pig_microbiome/PRJNA1439946/fastq_files" #Change me to the directory containing the fastq files(unzipped)
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(0,0),
              maxN=2, maxEE=c(2,2), truncQ=2, rm.phix=TRUE,
