...
```{r}
path <- "/home/brymoore/wsg_gtdb_tax/pig_microbiome/PRJNA393762/fastq_files/trimmed" #Change me to the directory containing the fastq files(unzipped)
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(220,200),
              ...
              compress=TRUE, multithread=FALSE, verbose = TRUE) # On Windows set multithread=FALSE (only needed for filterAndTrim)
head(out)
```
