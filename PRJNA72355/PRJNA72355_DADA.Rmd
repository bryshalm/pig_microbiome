...
```{r}
path <- "/home/brymoore/wsg_gtdb_tax/pig_microbiome/PRJNA72355/fastq_files" #Change me to the directory containing the fastq files(unzipped)
...
Reduced quite a bit for the sake of speed
