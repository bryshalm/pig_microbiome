...
```{r}
path <- "/home/brymoore/wsg_gtdb_tax/pig_microbiome/PRJNA252973/fastq_files" #Change me to the directory containing the fastq files(unzipped)
...
```{r}
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(250,240),
