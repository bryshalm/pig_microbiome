...
### Assign taxonomy
```{}
taxa <- assignTaxonomy(seqtab.nochim, "/home/brymoore/wsg_gtdb_tax/curated_GTDB/GTDB_bac120_arc53_ssu_r226_genus.fna.gz", multithread=TRUE)
```
...
Add the Species
```{}
taxa_species <- addSpecies(taxa, "GTDB_bac120_arc53_ssu_r226_species_parsed_CLASS_SPP_CLD.fa.gz")
```
