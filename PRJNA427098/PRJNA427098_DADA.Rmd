...
```{r}
path <- "/home/brymoore/wsg_gtdb_tax/pig_microbiome/PRJNA427098/fastq_files" #Change me to the directory containing the fastq files(unzipped)
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(0,0),
              ...
              compress=TRUE, multithread=F) # On Windows set multithread=FALSE (only needed for filterAndTrim)
head(out)
```
